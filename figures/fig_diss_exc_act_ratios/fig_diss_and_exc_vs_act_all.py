...
results_file = "results_sets_full.pkl"

if True:  # go through all the TOFSets (takes a bit)
...
for element, ax in axes.items():
    ...
    ax.get_figure().savefig(f"more diss and exc vs act for {element}.png")
    ax.get_figure().savefig(f"more diss and exc vs act for {element}.svg")
