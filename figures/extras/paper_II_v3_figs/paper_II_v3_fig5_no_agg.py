...
if True:  # fig 5a, with stability numbers plotted against total current density.
    ...
    if forpublication:
        fig5a.savefig("paper_II_v3_fig5a_no_agg.png")
        fig5a.savefig("paper_II_v3_fig5a_no_agg.svg")
...
if True:  # fig 5b, with norm. activity, exchange, and diss. plotted against potential!
    ...
    if forpublication:
        fig5b.savefig("paper_II_v3_fig5b_no_agg.png")
        fig5b.savefig("paper_II_v3_fig5b_no_agg.svg")
