...
for panel, e_id in {"a": 33, "b": 5, "c": 39, "d": 41}.items():
    ...
    if forpublication:
        ...
        fig.savefig(f"paper_II_v3_fig2{panel}.png")
        fig.savefig(f"paper_II_v3_fig2{panel}.svg")
...
with open("paper_II_v3_fig2_annotation.txt", "w") as f:
    f.writelines(lines)
